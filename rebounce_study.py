...
if not results_df.empty:
    ...
    print(results_df.sort_values('pct_positive_rebounce', ascending=False).head(10))
    best_row = results_df.loc[results_df['pct_positive_rebounce'].idxmax()]
    print(f"\nBest interval for positive rebounce: change_pct between {best_row['b']}% and {best_row['a']}%")
